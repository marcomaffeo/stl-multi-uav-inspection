function rho_stay = robustness_stay(pos_x, pos_y, pos_z, drone_ref, goal_ref, ...
    I, optimizationParameters)
% The "robustness_stay" MATLAB function produces as output the set of waypoints to
% stay in the goal. ALWAYS operator.
%
% Inputs:
...
for i = 1 : numel(rho_lb_pos_x)
    ...
    temp(i) = SmoothMin(temp_vec,C); % Implements ALWAYS

end

rho_stay = SmoothMin(temp,C); % Implements ALWAYS
